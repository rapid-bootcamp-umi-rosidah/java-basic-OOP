...
public class MainLogicInterface {
    public static void main(String[] args) {
        ...
        System.out.println("\n\nLogic 02 Soal 01");
        LogicInterface logic02Soal01 = new Logic02Soal01Impl(new BasicLogic(5));
        logic02Soal01.CetakArray();

        System.out.println("\n\nLogic 02 Soal 02");
        LogicInterface logic02Soal02 = new Logic02Soal02Impl(new BasicLogic(13));
        logic02Soal02.CetakArray();

        System.out.println("\n\nLogic 02 Soal 03");
        LogicInterface logic02Soal03 = new Logic02Soal03Impl(new BasicLogic(13));
        logic02Soal03.CetakArray();

        System.out.println("\n\nLogic 02 Soal 04");
        LogicInterface logic02Soal04 = new Logic02Soal04Impl(new BasicLogic(13));
        logic02Soal04.CetakArray();

        System.out.println("\n\nLogic 02 Soal 05");
        LogicInterface logic02Soal05 = new Logic02Soal05Impl(new BasicLogic(13));
        logic02Soal05.CetakArray();

        System.out.println("\n\nLogic 02 Soal 06");
        LogicInterface logic02Soal06 = new Logic02Soal06Impl(new BasicLogic(5));
